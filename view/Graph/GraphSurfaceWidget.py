...
class GraphSurfaceWidget(QtWidgets.QWidget):   
    def __init__(self, options, parent=None):
        super(GraphSurfaceWidget,self).__init__(parent)
    ...
    def draw(self):
        ...
        for vertex in self.parent().graph.vertices:
            ...
            pygame.draw.circle(self.surface, vertex.color, vertex.pos, self.options.POINTS_RADIUS-2, 0)
