...
from view.Graph.GraphSurfaceWidget import GraphSurfaceWidget
from view.Graph.GraphFormWidget import GraphFormWidget
from view.Graph.GraphActionWidget import GraphActionWidget
...
class GraphWidget(QWidget):
    ...
    def __init__(self, parent=None, graph=None):
        ...
        self.pygameWidget = GraphSurfaceWidget(self.options, self)
        self.formWidget = GraphFormWidget(self.options, self)
        self.actionWidget = GraphActionWidget(self.options, self)
